...
COPY /website/cloudapp/package.json ./
COPY /website/cloudapp/package-lock.json ./
RUN npm ci -f && mkdir /iroko-app && mv ./node_modules ./cloudapp
WORKDIR /iroko-app
...
WORKDIR /root/public/
COPY  --from=builderweb /cloudapp/dist .
WORKDIR /root/
